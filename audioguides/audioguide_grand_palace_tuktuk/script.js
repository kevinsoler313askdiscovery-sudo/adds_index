...
const activeTourIds = ['floating', 'chiang_rai', 'white_orchid', 'canal_tour', 'luxury_white', 'royal_princess', 'opulence_luxury', 'yodsiam_sightseeing', 'elephant_sanctuary', 'alangka_luxury'];
...
function loadHeroImages() {
    ...
    if (typeof heroImages !== 'undefined' && heroImages.length > 0) {
        heroImages.forEach((fileName, index) => {
            ...
            img.alt = `Grand Palace TukTuk ${index + 1}`;
...
// Puntos del tour: Grand Palace → Wat Arun → Wat Pho → Chinatown → Wat Traimit → Khao San Road
const tourMapPoints = [
    {
        lat: 13.749902696187496, 
        lng: 100.49159795767096, 
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.74385998917864, 
        lng: 100.48843327116452, 
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.746439332292635, 
        lng: 100.4927625711645,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.741824410866748, 
        lng: 100.50907402883547,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.737487954817079, 
        lng: 100.50873805767098,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.733955877294383, 
        lng: 100.51209244232902,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.737702289041707, 
        lng: 100.5134545,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 13.758112410504294, 
        lng: 100.49896737116451,
        url: 'https://monkeytravel.co'
    }
];
...
function initMap() {
    ...
    leafletMap = L.map('map').setView([firstPoint.lat, firstPoint.lng], 13);
