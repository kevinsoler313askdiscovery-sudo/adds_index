...
const activeTourIds = ['floating_market', 'chiang_rai', 'tuktuk', 'white_orchid', 'canal_tour', 'luxury_white', 'royal_princess', 'opulence_luxury', 'yodsiam_sightseeing', 'elephant_sanctuary', 'alangka_luxury'];
...
function loadHeroImages() {
    ...
    const imageFolder = '../../PICTURES/AYUTTHAYA WEB/';
...
function showPlayer() {
    ...
    // Mostrar mapa e inicializarlo la primera vez que es visible
