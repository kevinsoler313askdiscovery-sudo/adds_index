...
// Puntos del tour: Phuket → Tiger Cave Temple → Emerald Pool → Hot Springs
const tourMapPoints = [
    {
        lat: 8.123920589415414, 
        lng: 98.92512027116452,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 7.9251033659167005, 
        lng: 99.26813987116451,
        url: 'https://monkeytravel.co'
    },
    {
        lat: 7.931380860694013, 
        lng: 99.2057849,
        url: 'https://monkeytravel.co'
    },
];
...
function initMap() {
    ...
    const firstPoint = tourMapPoints[0] || { lat: 7.88, lng: 98.39 };
    leafletMap = L.map('map').setView([firstPoint.lat, firstPoint.lng], 9);
