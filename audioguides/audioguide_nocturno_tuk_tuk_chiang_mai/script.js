...
function loadPlaylist() {
    ...
    // Cambia el título según el idioma
    ...
    // Siempre actualizar el contenido de la promoción para reflejar el idioma seleccionado
    updatePromoContent();

    // Actualizar placeholder del buscador
    const searchInput = document.getElementById('languageSearch');
    if (searchInput) {
        searchInput.placeholder = t.searchPlaceholder || (currentLanguage === 'español' ? 'Buscar idioma...' : 'Search language...');
    }
...
function showPlayer() {
    ...
    // Mostrar sección de publicidad principal
    const promoSection = document.getElementById('promoSection');
    if (promoSection) promoSection.classList.add('show');

    // Ocultar sección de publicidad inicial
    const initialPromo = document.getElementById('initialPromoSection');
...
function updatePromoContent() {
    ...
    // Determinar el idioma para el contenido del anuncio de forma dinámica
