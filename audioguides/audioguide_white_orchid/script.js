...
const activeTourIds = ['floating', 'chiang_rai', 'tuktuk', 'canal_tour', 'luxury_white', 'royal_princess', 'opulence_luxury', 'yodsiam_sightseeing', 'elephant_sanctuary', 'alangka_luxury'];
...
// Actualizar gradiente de barra de progreso
