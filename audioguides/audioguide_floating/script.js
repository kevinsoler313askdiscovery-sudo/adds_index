...
const activeTourIds = ['chiang_rai', 'tuktuk', 'white_orchid', 'canal_tour', 'luxury_white', 'royal_princess', 'opulence_luxury', 'yodsiam_sightseeing', 'elephant_sanctuary', 'alangka_luxury'];
...
function loadHeroImages() {
    ...
    const imageFolder = '../../PICTURES/FLOATING WEB/';
